...
def evaluate(model_dir, data_dir, out_dir, file_list=None, calculate_distance=False):
...
if __name__ == "__main__":
    with open(sys.argv[4]) as file_list:
        ...
        lines = data['files']
    evaluate(sys.argv[1], sys.argv[2], sys.argv[3], lines, calculate_distance=True)
